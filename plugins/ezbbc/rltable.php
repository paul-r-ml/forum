...
<body onload="getSelection()">
  ...
  <textarea name="rltable" cols="80" rows="16"></textarea>
  </p>
  <p class="buttons"><input type="button" value="<?php echo $lang_ezbbc['OK'] ?>" onclick="insertRltableTag()" /> <input type="button" value="<?php echo $lang_ezbbc['Cancel'] ?>" onclick="self.close()" /></p>
  </form>
  </div>
  </div>
  </div>
