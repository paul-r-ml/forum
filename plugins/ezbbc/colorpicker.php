		...
		<div class="punwrap">
			<div id="brdmain">
				<div id="ezbbccolorpicker">
					...
					<?php echo $lang_ezbbc['Ask color'] ?><br />
					<input type="text" name="color_choice" id="color_choice" class="color {adjust:false,hash:true,caps:false,pickerOnfocus:false}" title="<?php echo $lang_ezbbc['Ask color explanation'] ?>" size="25" onchange="switchColor()" onkeydown="switchColor()" onkeyup="switchColor()"/>
					</p>
